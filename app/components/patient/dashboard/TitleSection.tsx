        ...
        <section className="flex justify-center w-full pt-10">
            <div className="flex justify-between items-center w-2/3">
                <div className="flex flex-col">
                    <h1 className="text-white text-2xl font-poppins font-bold">Olá, Lucas</h1>
                    <h2 className="text-slate-400 text-base font-inter">Bem-vindo ao seu painel de saúde</h2>
                </div>
                <div>
                    <Link 

        ...
        <div className="flex items-center gap-3 w-full">
            <div className="flex flex-col items-center gap-2 flex-1">
                <div className={`flex justify-center items-center w-14 h-14 bg-blue-400 rounded-2xl`}>
                    <span className={`text-slate-100 text-lg font-poppins font-bold`}>1</span>
                </div>
            ...
            <div className="flex flex-col items-center gap-2 flex-1">
                <div className={route2 ? "bg-blue-400" : "flex justify-center items-center w-14 h-14 bg-slate-400 rounded-2xl"}>
                    <span className={route2 ? "text-slate-100" : "text-slate-200 text-lg font-poppins font-bold"}>2</span>
                </div>
